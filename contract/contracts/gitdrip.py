...
# Constants
# ---------------------------------------------------------------------------
MIN_PERIOD_SEC = 7 * 24 * 3600          # T5 — anti-spam: at most one period/week
DORMANT_REFUND_SEC = 180 * 24 * 3600    # T8 — sponsor refund after 180d dormant
